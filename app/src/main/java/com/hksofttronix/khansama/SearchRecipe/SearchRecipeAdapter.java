...
public class SearchRecipeAdapter extends RecyclerView.Adapter<SearchRecipeAdapter.RecyclerViewHolders> {

    String tag = this.getClass().getSimpleName();

    ArrayList<recipeDetail> arrayList;
    Context context;
    SearchRecipeOnClick onclick;

    Globalclass globalClass;
    Mydatabase mydatabase;

    public SearchRecipeAdapter(Context context, ArrayList<recipeDetail> arrayList, SearchRecipeOnClick onClick) {
    ...
    public RecyclerViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.searchrecipe_rvitem, null);
