...
public class AllOrderAdapter extends RecyclerView.Adapter<AllOrderAdapter.RecyclerViewHolders> {
    ...
    public AllOrderAdapter(Context context, ArrayList<allOrderItemDetail> arrayList, AllOrderOnClick onClick) {
    ...
    public RecyclerViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.allorder_rvitem, null);
