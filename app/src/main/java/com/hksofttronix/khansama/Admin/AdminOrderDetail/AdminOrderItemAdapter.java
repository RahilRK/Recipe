...
public class AdminOrderItemAdapter extends RecyclerView.Adapter<AdminOrderItemAdapter.RecyclerViewHolders> {

    String tag = this.getClass().getSimpleName();

    ArrayList<allOrderItemDetail> arrayList;
    Context context;
    AdminOrderItemOnClick onClick;
    Globalclass globalClass;
    Mydatabase mydatabase;

    public AdminOrderItemAdapter(Context context, ArrayList<allOrderItemDetail> arrayList, AdminOrderItemOnClick onClick) {
    ...
    public RecyclerViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adminorderitem_rvitem, null);
    ...
    public class RecyclerViewHolders extends RecyclerView.ViewHolder {
        ...
        TextView recipeName,recipePrice,quantity;
