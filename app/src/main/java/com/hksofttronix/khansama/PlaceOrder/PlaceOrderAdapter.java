...
public class PlaceOrderAdapter extends RecyclerView.Adapter<PlaceOrderAdapter.RecyclerViewHolders> {

    String tag = this.getClass().getSimpleName();

    ArrayList<placeOrderDetail> arrayList;
    Context context;
    PlaceOrderOnClick onClick;
    Globalclass globalClass;
    Mydatabase mydatabase;

    public PlaceOrderAdapter(Context context, ArrayList<placeOrderDetail> arrayList, PlaceOrderOnClick onClick) {
    ...
    public RecyclerViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.placeorder_rvitem, null);
    ...
    public void onBindViewHolder(final RecyclerViewHolders holder, int position) {
        ...
        holder.orderDateTime.setText(globalClass.dateToString(model.getOrderDateTime(),"dd MMM yyyy hh:mm aa"));
    ...
    public class RecyclerViewHolders extends RecyclerView.ViewHolder {
        ...
        TextView recipeName,orderDateTime,item,total;
